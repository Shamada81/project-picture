...
var filter = function filter() {
  ...
  var typeFilter = function typeFilter(markType, target) {
  ...
  btnLovers.addEventListener('click', function (e) {
    typeFilter(markLovers, e.target);
  });
  btnChef.addEventListener('click', function (e) {
  ...
  btnGrandmother.addEventListener('click', function (e) {
    typeFilter(no, e.target);
  });
  btnGranddad.addEventListener('click', function (e) {
    typeFilter(no, e.target);
  });
};
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          throw new Error("Could nod fetch ".concat(url, ", status: ").concat(res.status));
